...
function BlogCard({ image, title, date, authorImage, author, id }) {
  return (
    <div className="flex flex-col items-center max-w-sm bg-white border border-gray-200 rounded-lg shadow-lg dark:bg-gray-800 dark:border-gray-700 m-3 ">
      <img
